...
minetest.register_node("hades_petz:parchment", {
	...
	on_construct = function(pos)
		minetest.add_entity(pos, "hades_petz:parchment_entity")
	end,
})

minetest.register_node("hades_petz:parchment_bg", {
...
minetest.register_entity("hades_petz:parchment_entity", {
    physical = false,
    collisionbox = {-0.4375, -0.375, 0.5, 0.4375, 0.3125, 0.5},
    visual = "wielditem",
    visual_size = {x=1, y=1},
    mesh = "hades_petz:parchment_bg",
