...
minetest.register_node("hades_petz:jack_o_lantern_grenade", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if not petz.spawn_throw_object(user, strength, "hades_petz:ent_jack_o_lantern_grenade") then
...
petz.register_throw_entity("hades_petz:ent_jack_o_lantern_grenade", "hades_petz:jack_o_lantern_grenade", petz.settings.pumpkin_grenade_damage, "fire", "fire", "petz_firecracker")
...
-- COBWEB
minetest.register_node("hades_petz:cobweb", {
	...
	liquid_viscosity = 11,
	liquidtype = "source",
	liquid_alternative_flowing = "hades_petz:cobweb",
	liquid_alternative_source = "hades_petz:cobweb",
...
petz.register_throw_entity("hades_petz:ent_cobweb", "hades_petz:cobweb", 1, "cobweb", nil, "petz_cobweb_throw")
