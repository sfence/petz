...
petz:register_egg("hades_petz:tropicalfish", S("Tropicalfish"), "petz_spawnegg_tropicalfish.png", true)

minetest.register_entity("hades_petz:tropicalfish_entity_sprite", {
	visual = "sprite",
	spritediv = {x = 1, y = 16},
